                ...
                editor.addListener('selectionchange', function (t, causeByUi) {
                    ...
                    if (editor.ui._dialogs.linkDialog) {
                        ...
                        if (link && (url = (link.getAttribute('_href') || link.getAttribute('href', 2)))) {
                            ...
                            var txt = title.substring(0, 20) + "...";
                            if (html) {
                                html += '<div style="height:5px;"></div>'
                            }
                            html += popup.formatHtml(`<nobr><a target="_blank" href="${url}" title="${title}">${txt}</a><span class="edui-clickable" onclick="$$._onEditButtonClick();">${editor.getLang("modify")}</span><span class="edui-clickable" onclick="$$._onRemoveButtonClick('unlink');">${editor.getLang("clear")}</span></nobr>`);
